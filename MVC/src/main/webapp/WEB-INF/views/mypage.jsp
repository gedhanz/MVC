...
<head>
    ...
    <link rel="stylesheet" href="/MVC/resources/css/mypage.css">
            ...
            <div class="user-info">
                ...
                <div class="info-box">
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-item">
                            <label>생년월일</label>
                            <input type="text" value="****년 **월 **일" disabled>
                        </div>
                    </div>
                    <div class="mypage-btn">
                        <div class="withdrawal-section">
                            <button class="useredit-button" onclick="location.href='/MVC/changePW'">비밀번호 변경</button>
                            <button class="withdrawal-button" onclick="location.href='/MVC/deleteID'">회원 탈퇴</button>
                        </div>
                    </div>
