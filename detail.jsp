            ...
            <body>
              <% String nickname=(String)session.getAttribute("nickname"); %>
                ...
                <header class="header">
                  <div class="logo">
                    <a href="/MVC/main">
                      <img src="https://i.pinimg.com/280x280_RS/12/5c/15/125c15498a72c53a784b7476ce8c5a22.jpg"
                        alt="Acorn Stay Logo">
                          ...
                          <% if(nickname==null){%>
                            ...
                            <% }%>
                              ...
                              <% if(nickname==null){%>
                                ...
                                <% }else{ %>
                                  <a href="/MVC/logout" class="mypage-button"><i class="fa-regular fa-user"></i>
                                    로그아웃</a>
                                  <% } %>
                  </nav>
                </header>
                <% AcornStayAccommodationDAO dao=new AcornStayAccommodationDAO(); AcornStayAccommodationDTO
                  dto=(AcornStayAccommodationDTO)request.getAttribute("dto"); ArrayList<AcornStayAccommodationImageDTO>
                  list = dao.getImages(dto.getId());
                    ...
                    <section aria-label="숙소 상세 정보" class="h_info">
                      ...
                      <div class="name_price">
                        ...
                        <div class="price_container">
                          <span class="price">2,000,000<!--<%=String.format("%,d", dto.getPrice()) %>--></span>
                  ...
                  <footer>
                    ...
                    <div class="footer-bottom">
                      <p>(주) 에이콘스테이<br>
                        ...
                        전자우편주소: help@acornstay.com | 통신판매업신고증 : 제 2022-서울마포-1597호 | 사업자등록번호:101-86-89995 | TEL:
                        02-2231-6412<br>
